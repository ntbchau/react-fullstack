                ...
                <div className='home-header-conntainer'>
                    <div className='home-header-content'>
                        ...
                        <div className='right-content'>
                            ...
                            <div className={language === LANGUAGES.VI ? 'language-vi active' : 'language-vi'}><span onClick={() => this.handleClickLanguage(LANGUAGES.VI)}>VI</span></div>
                            <div className={language === LANGUAGES.EN ? 'language-en active' : 'language-en'}><span onClick={() => this.handleClickLanguage(LANGUAGES.EN)}>EN</span></div>
                        </div>
                    </div>
                </div>
